...
def add_account(request):
    ...
    if request.method == 'POST':
        ...
        if account_form.is_valid():
            ...
            account = Account(account_username=account_username, account_password=account_password, account_app=account_app, account_user=user)
...
def update_account(request, account_id):
    ...
    account_form = AccountForm(initial={'account_username': account.account_username, 'account_password': account.account_password, 'account_app': account.account_app.app_id})
