...
class User(models.Model):
	...
	def get_by_cookie(self):
		isexpired = True
		if hasattr(self, 'user_id') and hasattr(self, 'user_cookie') and self.user_id is not None and self.user_cookie is not None:
			try:
...
class Account(models.Model):
	...
	def load_from_JSON(self,s):
		...
		sef.account_username = jsonAccount['account_username']
